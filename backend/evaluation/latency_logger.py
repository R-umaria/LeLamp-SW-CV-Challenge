...
class LatencyLogger:
    FIELDNAMES = [
        ...
        "gesture_reason",
        "speech_detected",
        "speaker_active_track_id",
        "speaker_active_track_location",
        "speaker_speaking_to_robot",
        "speaker_confidence",
        "speaker_reason",
        "speaker_doa_azimuth_deg",
        "speaker_policy_override",
        "speaker_policy_reason",
        "memory_write_count",
